...
glm::vec3 cam_pos = glm::vec3(0.0f, 0.0f, 15.0f);
glm::vec3 cam_front = glm::vec3(0.0f, 0.0f, -1.0f);
glm::vec3 cam_up = glm::vec3(0.0f, -1.0f, 0.0f);
// glm::vec3 cam_right = glm::normalize(glm::cross(cam_pos, cam_front)
bool keys[1024];
...
void mouse_callback(GLFWwindow* window, double x_pos, double y_pos)
{
    ...
    glm::quat x_rotation = glm::angleAxis(x_offset, cam_up);
	...
	cam_front = glm::normalize(x_rotation*cam_front);
	// cam_up = glm::normalize(x_rotation*cam_up);
