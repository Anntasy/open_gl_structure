...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(800, 500, "window", NULL, NULL);
	...
	GLuint texture = texture_data.add_texture("images.jpeg");
	...
	projection = glm::perspective(glm::radians(60.0f), HEIGHT/WIDTH, 0.05f, 50.0f);
	// show_m(projection);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform1i(glGetUniformLocation(shader.program, "texture_sample2"), 0);
